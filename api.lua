...
API.stop_animation = function()
    ...
    table.clear(mevreanim.animation.original_motor_c0s);
    table.clear(mevreanim.animation.joints);
    mevreanim.animation.state = { is_playing = false, current_url = nil, speed = 1.0, keyframes = nil, total_duration = 0, elapsed_time = 0 };
